...
def modify_image(image, resolution, new_width, new_height, save_size):
    # 修改分辨率
...
def app3():
    ...
    if uploaded_image is not None:
        ...
        modified_image = modify_image(image, resolution, new_width, new_height, (save_width, save_height))
